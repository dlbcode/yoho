    ...
    .then(data => {
      ...
      let headerRow = `<tr>
                    <th data-column="departure">
                        ...
                        <span class="resetIcon" id="resetDepartureFilter" style="display:none; cursor:pointer;">✕</span>
                    ...
                    <th data-column="arrival">
                        ...
                        <span class="resetIcon" id="resetArrivalFilter" style="display:none; cursor:pointer;">✕</span>
                    ...
                    <th data-column="price">
                        ...
                        <span class="resetIcon" id="resetPriceFilter" style="display:none; cursor:pointer;">✕</span>
