  ...
  fetch(apiUrl)
    ...
    .then(data => {
      ...
      let headerRow = `<tr>
                        ...
                        <span class="header" data-column="departure">
                      ...
                      <th data-column="arrival">
                        <span class="header" data-column="arrival">
                          <span class="filterButton" data-column="arrival">
                            <span class="filteredHeader" data-column="arrival">Arrival</span>
                            <img class="filterIcon" id="arrivalFilter" data-column="arrival" src="/assets/filter-icon.svg" alt="Filter">
                      ...
                      <th data-column="price">
                        <span class="header" data-column="price">
                          <span class="filterButton" data-column="price">
                            <span class="filteredHeader" data-column="price" id="priceText">Price</span>
                            <img class="filterIcon" id="priceFilter" data-column="price" src="/assets/filter-icon.svg" alt="Filter">
