...
const selectedRoute = {
    ...
    displayFullJourneyInfo: async function(groupId) {
                            ...
                            <div class="segment-details">
                                ...
                                <div class="segment-times">
                                    <div class="segment-departure">
                                        <div class="time">${this.formatFlightTime(new Date(segment.routeDetails.departure))}</div>
                                        <div class="date">${this.formatFlightDate(new Date(segment.routeDetails.departure))}</div>
                                        <div class="airport">${segment.origin}</div>
                                    </div>
                                    <div class="segment-arrow">→</div>
                                    <div class="segment-arrival">
                                        <div class="time">${this.formatFlightTime(new Date(segment.routeDetails.arrival))}</div>
                                        <div class="date">${this.formatFlightDate(new Date(segment.routeDetails.arrival))}</div>
        ...
        backButton.addEventListener('click', () => {
            ...
            this.displaySelectedRouteInfo(firstSegmentIndex);
        });
        ...
        segmentButtons.forEach(button => {
            ...
            button.addEventListener('click', () => {
                this.displaySelectedRouteInfo(parseInt(segmentIndex));
            });
        });
